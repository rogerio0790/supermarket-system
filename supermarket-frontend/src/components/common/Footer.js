...
import { FaMapMarkerAlt, FaPhone, FaEnvelope, FaCcVisa, FaCcMastercard, FaMoneyBillWave, FaMobileAlt } from 'react-icons/fa';
import './Footer.css';
          ...
          <div className="footer-grid">
            <div className="footer-column about">
              ...
              <div className="contact-details">
                <p><FaMapMarkerAlt /> Goico Plaza, Musanze - Muhoza, Rwanda</p>
                <p><FaPhone /> +250 788 000 000</p>
                <p><FaEnvelope /> info@rukarasupermarket.rw</p>
              </div>
            </div>
            ...
            <div className="footer-column payment-section">
              <h3>We Accept</h3>
              <div className="payment-methods">
                <div className="payment-item">
                  <div className="payment-icon-wrapper mtn-bg">
                    <FaMobileAlt className="payment-icon" />
                  </div>
                  <span>MTN Mobile Money</span>
                </div>
                <div className="payment-item">
                  <div className="payment-icon-wrapper airtel-bg">
                    <FaMobileAlt className="payment-icon" />
                  </div>
